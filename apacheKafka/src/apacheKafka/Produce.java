	...
	public static void main(String[] args) throws IOException {
		 ...
		 */
	     ...
	     String line = reader.readLine();
		  ...
		  while (line != null) { //String msg =
		  msg = "test message2 !! As a valued network customer you have been selected to receivea 900 prize reward! To claim call 09061701461. Claim code KL341. Valid 12 hours only."
		  ; msg = line.substring(line.indexOf(",")+1); // System.out.println(msg);
		...
		/*
		 * msg =
		 * "As a valued network customer you have been selected to receivea 900 prize reward! To claim call 09061701461. Claim code KL341. Valid 12 hours only."
		 * ; ProducerRecord<String, String> record = new ProducerRecord<>(topic, msg);
		 * producer.send(record);
		 */
		 producer.close();
